...
\setbeamertemplate{frametitle}{%
  \nointerlineskip
    \begin{beamercolorbox}[sep=0.5ex,wd=\paperwidth,leftskip=.2cm,rightskip=.2cm]{frametitle}%
...
\begin{frame}
	...
	\pause
	Homology is invariant under homotopy, weaker than invariance under homoemorphism. 
